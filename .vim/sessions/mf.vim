...
badd +27 ~/.certman
badd +102 ~/.vimrc
badd +0 app/controllers/bank_slip_configurations_controller.rb
args ~/.bashrc
edit ~/.vimrc
...
silent! normal! zE
let s:l = 102 - ((29 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
102
normal! 034l
tabedit app/controllers/bank_slip_configurations_controller.rb
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
